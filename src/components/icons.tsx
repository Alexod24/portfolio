...
export const Icons = {
  ...
  tailwindcss: (props: IconProps) => (
    <svg viewBox="0 0 54 33" xmlns="http://www.w3.org/2000/svg" className="size-8" {...props}>
  ...
  kick: (props: IconProps) => (
    <svg
      ...
      {...props}
    >
      <path d="M1.333 1.333h5.222v6.462h.116l4.49-6.462h6.14l-5.467 7.218 5.923 8.116H11.53l-4.975-7.394h-.116v13.394H1.333V1.333z" />
    </svg >
  ),
